...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'error_recall_patient_required'                           => '名患者を入力してください。',
    'error_recall_booking_recall_ym_required'                 => 'リコール月を選択してください。',
    'error_recall_p_tel_numeric'                              => '電話番号は数字でなければなりません。',
    ...
    */
    ...
    'error_q3_kind_required'                                => 'Q3入力してください。',
    'error_q3_sq_required'                                  => 'Q3医院名入力してください。',

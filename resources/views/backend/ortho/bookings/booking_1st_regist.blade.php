        ...
        <div class="table-responsive">
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <td><input type="text" name="p_name" id="p_name" class="form-control" value="{{ old('p_name') }}" /></td>
            </tr>

            <!-- p_name_kana -->
            <tr>
              <td class="col-title"><label for="p_name_kana">患者名よみ</label></td>
              <td><input type="text" name="p_name_kana" id="p_name_kana" class="form-control" value="{{ old('p_name_kana') }}" /></td>
            </tr>
            ...
            <tr>
              ...
              <td><textarea name="booking_memo" cols="60" rows="3" id="booking_memo" class="form-control">{{ old('booking_memo') }}</textarea></td>
            </tr>
          </table>
        </div>
    </div>

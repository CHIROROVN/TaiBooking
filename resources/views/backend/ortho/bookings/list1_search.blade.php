...
{!! Form::open( ['id' => 'frmList1Search', 'class' => 'form-horizontal','method' => 'post', 'route' => ['ortho.bookings.list1_search',$booking_id], 'enctype'=>'multipart/form-data', 'accept-charset'=>'utf-8']) !!}
   <section id="page">
        <div class="container">

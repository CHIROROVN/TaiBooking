            ...
            <div class="table-responsive clinic">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td><textarea name="clinic_memo" cols="50" rows="3" id="clinic_memo" class="form-control form-control-area">{{ $clinic->clinic_memo }}</textarea></td>
                </tr>
              </table>
              <table class="table table-bordered">
                <tbody>
              ...
              <div class="modal-dialog modal-sm">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <a href="{{ asset('ortho/clinics/delete/' . $clinic->clinic_id) }}" class="btn btn-sm btn-page">{{ trans('common.modal_btn_delete') }}</a>

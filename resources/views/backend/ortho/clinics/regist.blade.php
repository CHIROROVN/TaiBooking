...
@section('content')
  {!! Form::open(array('url' => 'ortho/clinics/regist', 'method' => 'post')) !!}
    <section id="page">
      <div class="container">
            ...
            <div class="table-responsive clinic">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" name="clinic_display_name" id="clinic_display_name " class="form-control" value="{{ old('clinic_display_name') }}" />
                  ...
                  <td colspan="2">
                    <select name="area" id="area" class="form-control form-control--small">
                      ...
                      @if(!empty($areas) && count($areas) > 0)
                        ...
                        <option value="{{ $area->area_id }}" @if(old('area') == $area->area_id) {{'selected'}} @endif>{{ $area->area_name }}</option>
                        @endforeach
                      @endif
                    </select>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <select name="clinic_status1" id="clinic_status1" class="form-control form-control--smaller">
                      <option value="1" @if(old('clinic_status1') == 1) {{'selected'}} @endif>はい</option>
                      <option value="0" @if(old('clinic_status1') == 0) {{'selected'}} @endif>いいえ</option>
                    </select>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <select name="clinic_status2" id="clinic_status2" class="form-control form-control--smaller">
                        <option value="1" @if(old('clinic_status2') == 1) {{'selected'}} @endif>はい</option>
                        <option value="0" @if(old('clinic_status2') == 0) {{'selected'}} @endif>いいえ</option>
                    </select>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <select name="clinic_status3" id="clinic_status3" class="form-control form-control--smaller">
                      <option value="1" @if(old('clinic_status3') == 1) {{'selected'}} @endif>はい</option>
                      <option value="0" @if(old('clinic_status3') == 0) {{'selected'}} @endif>いいえ</option>
                    </select>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <select name="clinic_status4" id="clinic_status4" class="form-control form-control--smaller">
                      <option value="1" @if(old('clinic_status4') == 1) {{'selected'}} @endif>はい</option>
                      <option value="0" @if(old('clinic_status4') == 0) {{'selected'}} @endif>いいえ</option>
                    </select>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <select name="clinic_status5" id="clinic_status5" class="form-control form-control--smaller">
                      <option value="1" @if(old('clinic_status5') == 1) {{'selected'}} @endif>はい</option>
                      <option value="0" @if(old('clinic_status5') == 0) {{'selected'}} @endif>いいえ</option>
                    </select>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" name="clinic_tel" id="clinic_tel" class="form-control form-control--small" value="{{ old('clinic_tel') }}" />
                ...
                <tr>
                  ...
                  <td><input type="text" name="clinic_tel_ip" id="clinic_tel_ip" class="form-control form-control--small" value="{{ old('clinic_tel_ip') }}" /></td>
                </tr>
                <tr>
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td><div class="checkbox"><label><input type="checkbox" name="clinic_sun_work" id="clinic_sun_work" value="1" @if(old('clinic_sun_work') == 1) {{'checked'}} @endif />はい</label></div></td>
                  <td>
                    <select name="clinic_sun_am_start_h" id="clinic_sun_am_start_h" class="form-control form-control--smaller">
                      ...
                      <option value="{{ $clinic_am_start }}" @if(old('clinic_sun_am_start_h') == $clinic_am_start) {{'selected'}} @endif>{{ $clinic_am_start }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_sun_am_start_m" id="clinic_sun_am_start_m" class="form-control form-control--smaller">
                      ...
                      <option value="{{ $clinic_m }}" @if(old('clinic_sun_am_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_sun_am_end_h" id="clinic_sun_am_end_h" class="form-control form-control--smaller">
                      ...
                      <option value="{{ $clinic_am_end }}" @if(old('clinic_sun_am_end_h') == $clinic_am_end) {{'selected'}} @endif>{{ $clinic_am_end }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_sun_am_end_m" id="clinic_sun_am_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_sun_am_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select></td>
                  <td>
                    <select name="clinic_sun_pm_start_h" id="clinic_sun_pm_start_h" class="form-control form-control--smaller">
                      ...
                      <option value="{{ $clinic_pm }}" @if(old('clinic_sun_pm_start_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_sun_pm_start_m" id="clinic_sun_pm_start_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_sun_pm_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_sun_pm_end_h" id="clinic_sun_pm_end_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_pms as $clinic_pm)
                      <option value="{{ $clinic_pm }}" @if(old('clinic_sun_pm_end_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_sun_pm_end_m" id="clinic_sun_pm_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_sun_pm_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select></td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class="checkbox"><label><input type="checkbox" name="clinic_mon_work" id="clinic_mon_work" value="1" @if(old('clinic_mon_work') == 1) {{'checked'}} @endif />はい</label></div></td>
                  <td>
                    <select name="clinic_mon_am_start_h" id="clinic_mon_am_start_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_am_starts as $clinic_am_start)
                      <option value="{{ $clinic_am_start }}" @if(old('clinic_mon_am_start_h') == $clinic_am_start) {{'selected'}} @endif>{{ $clinic_am_start }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_mon_am_start_m" id="clinic_mon_am_start_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_mon_am_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_mon_am_end_h" id="clinic_mon_am_end_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_am_ends as $clinic_am_end)
                      <option value="{{ $clinic_am_end }}" @if(old('clinic_mon_am_end_h') == $clinic_am_end) {{'selected'}} @endif>{{ $clinic_am_end }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_mon_am_end_m" id="clinic_mon_am_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_mon_am_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                  </td>
                  <td>
                    <select name="clinic_mon_pm_start_h" id="clinic_mon_pm_start_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_pms as $clinic_pm)
                      <option value="{{ $clinic_pm }}" @if(old('clinic_mon_pm_start_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_mon_pm_start_m" id="clinic_mon_pm_start_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_mon_pm_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_mon_pm_end_h" id="clinic_mon_pm_end_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_pms as $clinic_pm)
                      <option value="{{ $clinic_pm }}" @if(old('clinic_mon_pm_end_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_mon_pm_end_m" id="clinic_mon_pm_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_mon_pm_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td><div class="checkbox"><label><input type="checkbox" name="clinic_tue_work" id="clinic_tue_work" value="1" @if(old('clinic_tue_work') == 1) {{'checked'}} @endif />はい</label></div></td>
                  <td>
                    <select name="clinic_tue_am_start_h" id="clinic_tue_am_start_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_am_starts as $clinic_am_start)
                      <option value="{{ $clinic_am_start }}" @if(old('clinic_tue_am_start_h') == $clinic_am_start) {{'selected'}} @endif>{{ $clinic_am_start }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_tue_am_start_m" id="clinic_tue_am_start_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_tue_am_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_tue_am_end_h" id="clinic_tue_am_end_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_am_ends as $clinic_am_end)
                      <option value="{{ $clinic_am_end }}" @if(old('clinic_tue_am_end_h') == $clinic_am_end) {{'selected'}} @endif>{{ $clinic_am_end }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_tue_am_end_m" id="clinic_tue_am_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_tue_am_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select></td>
                  <td>
                    <select name="clinic_tue_pm_start_h" id="clinic_tue_pm_start_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_pms as $clinic_pm)
                      <option value="{{ $clinic_pm }}" @if(old('clinic_tue_pm_start_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_tue_pm_start_m" id="clinic_tue_pm_start_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_tue_pm_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_tue_pm_end_h" id="clinic_tue_pm_end_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_pms as $clinic_pm)
                      <option value="{{ $clinic_pm }}" @if(old('clinic_tue_pm_end_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_tue_pm_end_m" id="clinic_tue_pm_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_tue_pm_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td><div class="checkbox"><label><input type="checkbox" name="clinic_wed_work" id="clinic_wed_work" value="1" @if(old('clinic_wed_work') == 1) {{'checked'}} @endif />はい</label></div></td>
                  <td>
                    <select name="clinic_wed_am_start_h" id="clinic_wed_am_start_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_am_starts as $clinic_am_start)
                        <option value="{{ $clinic_am_start }}" @if(old('clinic_wed_am_start_h') == $clinic_am_start) {{'selected'}} @endif>{{ $clinic_am_start }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_wed_am_start_m" id="clinic_wed_am_start_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_wed_am_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_wed_am_end_h" id="clinic_wed_am_end_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_am_ends as $clinic_am_end)
                      <option value="{{ $clinic_am_end }}" @if(old('clinic_wed_am_end_h') == $clinic_am_end) {{'selected'}} @endif>{{ $clinic_am_end }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_wed_am_end_m" id="clinic_wed_am_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_wed_am_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select></td>
                  <td>
                    <select name="clinic_wed_pm_start_h" id="clinic_wed_pm_start_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_pms as $clinic_pm)
                      <option value="{{ $clinic_pm }}" @if(old('clinic_wed_pm_start_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_wed_pm_start_m" id="clinic_wed_pm_start_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_wed_pm_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_wed_pm_end_h" id="clinic_wed_pm_end_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_pms as $clinic_pm)
                      <option value="{{ $clinic_pm }}" @if(old('clinic_wed_pm_end_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_wed_pm_end_m" id="clinic_wed_pm_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_wed_pm_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td><div class="checkbox"><label><input type="checkbox" name="clinic_thu_work" id="clinic_thu_work" value="1" @if(old('clinic_thu_work') == 1) {{'checked'}} @endif />はい</label></div></td>
                  <td>
                    <select name="clinic_thu_am_start_h" id="clinic_thu_am_start_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_am_starts as $clinic_am_start)
                        <option value="{{ $clinic_am_start }}" @if(old('clinic_thu_am_start_h') == $clinic_am_start) {{'selected'}} @endif>{{ $clinic_am_start }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_thu_am_start_m" id="clinic_thu_am_start_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_thu_am_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_thu_am_end_h" id="clinic_thu_am_end_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_am_ends as $clinic_am_end)
                      <option value="{{ $clinic_am_end }}" @if(old('clinic_thu_am_end_h') == $clinic_am_end) {{'selected'}} @endif>{{ $clinic_am_end }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_thu_am_end_m" id="clinic_thu_am_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_thu_am_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                  </td>
                  <td>
                    <select name="clinic_thu_pm_start_h" id="clinic_thu_pm_start_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_pms as $clinic_pm)
                      <option value="{{ $clinic_pm }}" @if(old('clinic_thu_pm_start_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_thu_pm_start_m" id="clinic_thu_pm_start_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_thu_pm_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_thu_pm_end_h" id="clinic_thu_pm_end_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_pms as $clinic_pm)
                      <option value="{{ $clinic_pm }}" @if(old('clinic_thu_pm_end_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_thu_pm_end_m" id="clinic_thu_pm_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_thu_pm_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td><div class="checkbox"><label><input type="checkbox" name="clinic_fri_work" id="clinic_fri_work" value="1" @if(old('clinic_fri_work') == 1) {{'checked'}} @endif />はい</label></div></td>
                  <td>
                    <select name="clinic_fri_am_start_h" id="clinic_fri_am_start_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_am_starts as $clinic_am_start)
                        <option value="{{ $clinic_am_start }}" @if(old('clinic_fri_am_start_h') == $clinic_am_start) {{'selected'}} @endif>{{ $clinic_am_start }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_fri_am_start_m" id="clinic_fri_am_start_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_fri_am_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_fri_am_end_h" id="clinic_fri_am_end_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_am_ends as $clinic_am_end)
                      <option value="{{ $clinic_am_end }}" @if(old('clinic_fri_am_end_h') == $clinic_am_end) {{'selected'}} @endif>{{ $clinic_am_end }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_fri_am_end_m" id="clinic_fri_am_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_fri_am_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                  </td>
                  <td>
                    <select name="clinic_fri_pm_start_h" id="clinic_fri_pm_start_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_pms as $clinic_pm)
                      <option value="{{ $clinic_pm }}" @if(old('clinic_fri_pm_start_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_fri_pm_start_m" id="clinic_fri_pm_start_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_fri_pm_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_fri_pm_end_h" id="clinic_fri_pm_end_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_pms as $clinic_pm)
                      <option value="{{ $clinic_pm }}" @if(old('clinic_fri_pm_end_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_fri_pm_end_m" id="clinic_fri_pm_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_fri_pm_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td><div class="checkbox"><label><input type="checkbox" name="clinic_sat_work" id="clinic_sat_work" value="1" @if(old('clinic_sat_work') == 1) {{'checked'}} @endif />はい</label></div></td>
                  <td>
                    <select name="clinic_sat_am_start_h" id="clinic_sat_am_start_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_am_starts as $clinic_am_start)
                        <option value="{{ $clinic_am_start }}" @if(old('clinic_sat_am_start_h') == $clinic_am_start) {{'selected'}} @endif>{{ $clinic_am_start }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_sat_am_start_m" id="clinic_sat_am_start_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_sat_am_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_sat_am_end_h" id="clinic_sat_am_end_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_am_ends as $clinic_am_end)
                      <option value="{{ $clinic_am_end }}" @if(old('clinic_sat_am_end_h') == $clinic_am_end) {{'selected'}} @endif>{{ $clinic_am_end }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_sat_am_end_m" id="clinic_sat_am_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_sat_am_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select></td>
                  <td>
                    <select name="clinic_sat_pm_start_h" id="clinic_sat_pm_start_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_pms as $clinic_pm)
                      <option value="{{ $clinic_pm }}" @if(old('clinic_sat_pm_start_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_sat_pm_start_m" id="clinic_sat_pm_start_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_sat_pm_start_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                    ～　
                    <select name="clinic_sat_pm_end_h" id="clinic_sat_pm_end_h" class="form-control form-control--smaller">
                      <option value="">--時</option>
                      @foreach($clinic_pms as $clinic_pm)
                      <option value="{{ $clinic_pm }}" @if(old('clinic_sat_pm_end_h') == $clinic_pm) {{'selected'}} @endif>{{ $clinic_pm }}</option>
                      @endforeach
                    </select>
                    <select name="clinic_sat_pm_end_m" id="clinic_sat_pm_end_m" class="form-control form-control--smaller">
                      <option value="">--分</option>
                      @foreach($clinic_ms as $clinic_m)
                      <option value="{{ $clinic_m }}" @if(old('clinic_sat_pm_end_m') == $clinic_m) {{'selected'}} @endif>{{ $clinic_m }}</option>
                      @endforeach
                    </select>
                  </td>
                </tr>
        ...
        <div class="row margin-bottom">
          <div class="col-md-12 text-center">
            <a href="{{ asset('ortho/clinics') }}" class="btn btn-sm btn-page mar-right">登録済み医院一覧に戻る</a>
          </div>
        </div>
      </div>
    </section>

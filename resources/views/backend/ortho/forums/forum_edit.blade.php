...
@section('content')
    <!-- Content forum regist -->
      <section id="page">
        <div class="container">
        {!! Form::open(array('route' => ['ortho.forums.forum_edit', $comment->forum_id], 'enctype'=>'multipart/form-data', 'accept-charset'=>'utf-8')) !!}
              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  <tr>
                    ...
                    <td><input type="text" name="forum_title" id="forum_title" class="form-control form-control--sm" value="@if(!empty(old('forum_title'))){{old('forum_title')}}@else{{$comment->forum_title}} @endif" />
                  ...
                  <tr>
                    ...
                    <td>
                      <textarea name="forum_contents" cols="80" rows="5" id="forum_contents" class="form-control form-control-full">@if(!empty(old('forum_contents'))){{old('forum_contents')}}@else{{$comment->forum_contents}} @endif</textarea>
                  ...
                  <tr>
                    ...
                    <!-- upload file -->
                      ...
                      <!-- End upload file -->
                      →ファイル名：
                      <input name="forum_file_name" id="forum_file_name" type="text" class="form-control form-control--sm" value="{{old('forum_file_name')}}" />
          ...
          <div class="row margin-bottom">
            <div class="col-md-12 text-center">
              <input value="保存する" type="submit" class="btn btn-sm btn-page">
          </div>
          </div>
          <div class="row margin-bottom">
            <div class="col-md-12 text-center">

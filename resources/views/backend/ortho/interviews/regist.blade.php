  ...
  <table class="table table-bordered interview-regist">
    <tbody>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-5 col-md-4 col-lg-3">
              <select class="form-control" name="" id="">
                <option value="1"  >たい矯正歯科</option>
                <option value="3"  >あかまつデンタル</option>
                <option value="4"  >アップル歯科クリニック</option>
                <option value="5"  >あべ小児歯科</option>
                <option value="6"  >あゆみ歯科クリニック</option>
                <option value="7"  >飯田歯科医院</option>
                <option value="8"  >いけだ歯科クリニック</option>
                <option value="9"  >いしわり歯科医院</option>
                <option value="10"  >今浜歯科医院</option>
                <option value="11"  >イースト歯科クリニック</option>
                <option value="12"  >上本町ヒルズ歯科クリニック</option>
                <option value="13"  >うらやす歯科医院</option>
                <option value="14"  >エンドウ歯科医院</option>
                <option value="15"  >太田歯科</option>
                <option value="16"  >おおつき歯科クリニック</option>
                <option value="17"  >岡山協立病院</option>
                <option value="18"  >岡山大学医学部・歯学部附属病院</option>
                <option value="19"  >奥田歯科医院</option>
                <option value="20"  >かとう歯科・デイサービスセンターきらり</option>
                <option value="21"  >かどや歯科医院</option>
                <option value="22"  >苅田歯科医院</option>
                <option value="23"  >かわい歯科クリニック</option>
                <option value="24"  >かわいデンタルクリニック</option>
                <option value="25"  >川崎医科大学附属病院</option>
                <option value="26"  >かんざき歯科医院</option>
                <option value="27"  >がもう歯科医院</option>
                <option value="28"  >木下歯科医院</option>
                <option value="29"  >木村歯科医院</option>
                <option value="30"  >倉敷リバーサイド病院</option>
                <option value="31"  >クリスタルデンタルクリニック</option>
                <option value="32"  >くれいし歯科クリニック</option>
                <option value="33"  >クレオ歯科医院</option>
                <option value="34"  >Grand dental clinic</option>
                <option value="35"  >グリーン歯科クリニック</option>
                <option value="36"  >けやき通り歯科</option>
                <option value="37"  >こうづき歯科</option>
                <option value="38"  >こやま子ども歯科クリニック</option>
                <option value="39"  >さいとう歯科医院</option>
                <option value="40"  >さかい歯科クリニック</option>
                <option value="41"  >さとう歯科クリニック</option>
                <option value="42"  >しげはら歯科クリニック</option>
                <option value="43"  >島田が丘歯科</option>
                <option value="44"  >しみず歯科クリニック</option>
                <option value="45"  >正畠歯科医院</option>
                <option value="46"  >白髪歯科医院</option>
                <option value="47"  >しんご歯科</option>
                <option value="48"  >城東台ファミリー歯科</option>
                <option value="49"  >すずらん歯科</option>
                <option value="50"  >砂田歯科医院</option>
                <option value="51"  >砂田内科</option>
                <option value="52"  >妹尾歯科</option>
                <option value="53"  >妹尾歯科医院</option>
                <option value="54"  >たかた歯科クリニック</option>
                <option value="55"  >高橋歯科診療所</option>
                <option value="56"  >たかやま歯科</option>
                <option value="57"  >武内歯科医院</option>
                <option value="58"  >たけふ生協歯科診療所</option>
                <option value="59"  >歯科たけむらクリニック</option>
                <option value="60"  >多田歯科医院</option>
                <option value="61"  >千原歯科クリニック</option>
                <option value="62"  >土山歯科医院</option>
                <option value="63"  >とよはま歯科 </option>
                <option value="64"  >内藤歯科医院</option>
                <option value="65"  >中川歯科医院 </option>
                <option value="66"  >なかしま歯科医院</option>
                <option value="67"  >中村歯科医院 </option>
                <option value="68"  >ながれ歯科医院</option>
                <option value="69"  > ナツアキ歯科</option>
                <option value="70"  >なつかわ歯科 </option>
                <option value="71"  >新見歯科医院</option>
                <option value="72"  >はなふさ歯科医院</option>
                <option value="73"  >はやし歯科クリニック </option>
                <option value="74"  >はるき小児矯正歯科</option>
                <option value="75"  >ハロー歯科</option>
                <option value="76"  >パルフェ歯科医院 </option>
                <option value="77"  >彦歯科医院 </option>
                <option value="78"  >ひまわり歯科</option>
                <option value="79"  >ひらかわ歯科クリニック </option>
                <option value="80"  >平吾歯科クリニック</option>
                <option value="81"  >平松歯科</option>
                <option value="82"  >ひろおか歯科医院</option>
                <option value="83"  >ビーンズ歯科クリニック</option>
                <option value="84"  >ファミリー歯科松永歯科医院</option>
                <option value="85"  >ファミール歯科</option>
                <option value="86"  >福田歯科</option>
                <option value="87"  >ふじた歯科医院 </option>
                <option value="88"  >藤本耳鼻咽喉科クリニック　言語聴覚室</option>
                <option value="89"  >藤原歯科医院 </option>
                <option value="90"  >藤原歯科クリニック</option>
                <option value="91"  >古川歯科医院</option>
                <option value="92"  >BLANC DENTAL CLINIC </option>
                <option value="93"  >ブランデンタルクリニック加西</option>
                <option value="94"  > 緑川歯科 </option>
                <option value="95"  >宮本歯科医院 </option>
                <option value="96"  >むとう歯科医院 </option>
                <option value="97"  >山手グリーン歯科医院 </option>
                <option value="98"  >湯浅歯科医院</option>
                <option value="99"  >ゆめはんな歯科クリニック </option>
                <option value="100"  >横山みちよ歯科</option>
                <option value="101"  >よし歯科 </option>
                <option value="102"  >よしだ歯科 </option>
                <option value="103"  >ヨリタ歯科クリニック </option>
                <option value="104"  >わかさハーモニー歯科 </option>
                <option value="105"  >和気歯科医院 </option>
                <option value="106"  >渡里歯科 </option>
                <option value="107"  >さくら通り矯正歯科</option>
                <option value="108"  >飯田歯科医院</option>
                <option value="109"  >いしわり歯科医院</option>
                <option value="110"  >上本町ヒルズ歯科クリニック</option>
                <option value="111"  >エンドウ歯科医院</option>
                <option value="112"  >かわい歯科クリニック</option>
                <option value="113"  >かんざき歯科医院</option>
                <option value="114"  >グリーン歯科クリニック</option>
                <option value="115"  >けやき通り歯科</option>
                <option value="116"  >さかい歯科クリニック</option>
                <option value="117"  >しみず歯科クリニック</option>
                <option value="118"  >すずらん歯科</option>
                <option value="119"  >砂田歯科医院</option>
                <option value="120"  >たかやま歯科</option>
                <option value="121"  >武内歯科医院</option>
                <option value="122"  >なかしま歯科医院</option>
                <option value="123"  >なつかわ歯科 </option>
                <option value="124"  >はやし歯科クリニック </option>
                <option value="125"  >ビーンズ歯科クリニック</option>
                <option value="126"  >ファミリー歯科松永歯科医院</option>
                <option value="127"  >ファミール歯科</option>
                <option value="128"  >BLANC DENTAL CLINIC </option>
                <option value="129"  >ブランデンタルクリニック加西</option>
                <option value="130"  > 緑川歯科 </option>
                <option value="131"  >むとう歯科医院 </option>
                <option value="132"  >山手グリーン歯科医院 </option>
                <option value="133"  >ゆめはんな歯科クリニック </option>
                <option value="134"  >横山みちよ歯科</option>
                <option value="135"  >よしだ歯科 </option>
                <option value="136"  >ヨリタ歯科クリニック </option>
                <option value="137"  >アルファデンタルクリニック</option>
              </select>
              <span class="error-input">※必須</span>
            </div>
            <div class="col-xs-12 col-sm-7 col-md-5 col-lg-5 form-horizontal">
              <label class="control-label col-sm-4 col-md-3 col-lg-3" for="txt1">日付：</label>
              <div class="col-sm-8 col-md-9 col-lg-7">
                <input class="form-control" type="text" name="textfield2" id="txt1" />
                <span class="error-input">※必須</span>
              </div>
            </div>
          </div>
        ...
        <td>
          <div class="row">
            ...
            <div class="col-sm-7 col-md-5 col-lg-5 form-horizontal">
              <label class="control-label col-sm-4 col-md-3 col-lg-3" for="txt1">日付：</label>
              <div class="col-sm-8 col-md-9 col-lg-7">
                <input class="form-control" type="text" name="textfield2" id="txt2" />
                <span class="error-input">※必須</span>
              </div>
            </div>
          </div>
      ...
      <tr>
        <td>相談担当者</td>
        <td>
          <select class="form-control person-charge" name="" id="">
            <option data-hidden="true"></option>
            <option value="17"  >赤木秀瑛</option>
            <option value="13"  >池田和央</option>
            <option value="21"  >池田美和</option>
            <option value="28"  >石田亮人</option>
            <option value="80"  >石原</option>
            <option value="24"  >井原大輔</option>
            <option value="16"  >大村周平</option>
            <option value="26"  >草山知津子</option>
            <option value="22"  >鷺坂泰世</option>
            <option value="18"  >笹谷香織</option>
            <option value="12"  >佐藤康守</option>
            <option value="29"  >清水清恵</option>
            <option value="10"  >田井規能</option>
            <option value="11"  >田井尚子</option>
            <option value="25"  >高木淳</option>
            <option value="7"  >高木雅人</option>
            <option value="20"  >高山愛子</option>
            <option value="79"  >谷野</option>
            <option value="9"  >担当Dr.なし</option>
            <option value="19"  >中川綾子</option>
            <option value="78"  >林大祐</option>
            <option value="15"  >林咲子</option>
            <option value="14"  >三浦明日香</option>
            <option value="27"  >村上誠二</option>
            <option value="23"  >山野栄三</option>
            <option value="83"  >チロロテスト</option>
            <option value="4"  >チロロネット</option>
            <option value="82"  >test</option>
            <option value="8"  >ドクター2</option>
          </select>
          <span class="error-input">※必須</span>
        </td>
      </tr>
        ...
        <td>
          <div class="row">
            ...
            <div class="col-sm-7 col-md-5 col-lg-5 form-horizontal">
              <label class="control-label col-sm-4 col-md-3 col-lg-3" for="txt1">日付：</label>
              <div class="col-sm-8 col-md-9 col-lg-7">
                <input class="form-control" type="text" name="textfield2" id="txt3" />
                <span class="error-input">※必須</span>
              </div>
            </div>
          </div>
          ...
          <td colspan="2">
            <div class="row">
              <div class="col-md-12 col-lg-12">
                ...
                <input type="radio" name="q7_kind" id="q7_kind_1" value="1">はい</label>
                <div class="col-md-12 col-lg-12">
                  <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3">
            ...
            <div class="row">
              <div class="col-md-12 col-lg-12">
                ...
                <input type="radio" name="q7_kind" id="q7_kind_2" value="2">いいえ </label>
              </div>
            </div>
          </td>
      </tr>
          ...
          <td colspan="2">
            <div class="row">
              <div class="col-md-12 col-lg-12">
                ...
                <input type="radio" name="q13_kind" id="q13_kind_1">はい</label>
                <div class="row">
                  <div class="col-md-12 col-lg-12">
            ...
            <div class="row">
              <div class="col-md-12 col-lg-12">
                ...
                <input type="radio" name="q13_kind" id="q13_kind_2">いいえ </label>
              </div>
            </div>
          </td>
      </tr>

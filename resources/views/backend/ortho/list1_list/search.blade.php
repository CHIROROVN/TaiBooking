...
{!! Form::open( ['id' => 'frmList1Search', 'class' => 'form-horizontal','method' => 'post', 'route' => ['ortho.list1_list.search', $id], 'enctype'=>'multipart/form-data', 'accept-charset'=>'utf-8']) !!}
   <section id="page">
        <div class="container">
          ...
          <div class="row margin-bottom">
            <div class="col-md-12 text-center">
              ...
              <input name="BookingTel" id="BookingTel" value="検索開始（一覧表表示）" type="submit" class="btn btn-sm btn-page mar-right">

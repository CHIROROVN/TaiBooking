        ...
        <div class="row content content--menu">
          ...
          <div class="col-md-4 col-lg-4">
            ...
            <ul>
              ...
              <li><a href="{{ route('ortho.bookings.booking_search',['search'=>'advance']) }}"><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>予約を取る</a></li>
              ...
              <li><a href="{{ route('ortho.bookings.booking.monthly', ['area_id'=> @$area_id, 'clinic_id'=>@$clinic_id, 'u_id' => @$u_id]) }}"><p><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>予約簿の表示</a></li>
              @endif
              @if ( Auth::user()->u_power_booking == -1 && Auth::user()->u_power2 == 1 )
          ...
          <div class="col-md-4 col-lg-4">
            ...
            <ul>
              ...
              <li><a href="{{ route('ortho.bookings.template.set') }}"><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>予約簿テンプレートの適用と個別調整</a></li>
            </ul>
            @endif

        ...
        <div class="row content content--menu">
          ...
          <div class="col-md-4 col-lg-4">
            ...
            <ul>
              ...
              <li><a href="{{ route('ortho.bookings.template.set', [ 's_clinic_id' => $clinic_id ]) }}"><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>予約簿テンプレートの適用と個別調整</a></li>
            </ul>
            @endif
            ...
            <ul>
              ...
              <li><a href="{{ route('ortho.bookings.list3_list') }}"><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>「リコール」リストの表示</a></li>

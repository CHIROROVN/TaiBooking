        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <div class="checkbox">
                <label><input type="checkbox" name="u_power11" @if($user->u_power11 == 1) {{'checked'}} @endif value="1">メモ管理</label>
              </div>
              <div class="dropdown">
                <select name="u_power12" id="u_power12" style="width:100px;">
                  <option value="" @if($user->u_power12 == '') selected="" @endif >正常</option>
                  <option value="1" @if($user->u_power12 == 1) selected="" @endif >伝言板/私設</option>
                  <option value="2" @if($user->u_power12 == 2) selected="" @endif >伝言板/公衆</option>
                </select>  <span class="power">伝言板</span>
              </div>
            </td>
          </tr>
          <tr>

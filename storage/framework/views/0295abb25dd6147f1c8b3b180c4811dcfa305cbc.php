      ...
      <div class="container">
        <div class="row content content--menu">
          ...
          <div class="col-md-4 col-lg-4">
            ...
            <!-- power 11 -->
            <?php if(!empty(Auth::user()->u_power11)): ?>
            <h2>メモ管理</h2>
            <ul>
            ...
            <h2>伝言板</h2>
            <ul>
              <li><a href="<?php echo e(route('ortho.forums.forum_list')); ?>"><p><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>伝言板の新規登録・一覧</a></li>
            </ul>

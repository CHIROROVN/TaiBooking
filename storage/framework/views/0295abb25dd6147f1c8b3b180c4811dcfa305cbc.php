      ...
      <div class="container">
        <div class="row content content--menu">
          ...
          <div class="col-md-4 col-lg-4">
            ...
            <h2>医院情報管理</h2>
            <ul>
              <li><a href="<?php echo e(route('ortho.clinics.index')); ?>"><p><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>医院の新規登録・一覧・変更・削除・設備管理・予約簿テンプレート管理・予約枠管理</a></li>
            </ul>
            <?php endif; ?>

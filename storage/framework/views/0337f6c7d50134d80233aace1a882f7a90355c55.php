            ...
            <?php if(!empty($bookings[0])): ?>
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                      <?php if( $bookings[0]->booking_status == 1 ): ?>
                      通常
                      <?php elseif( $bookings[0]->booking_status == 2 ): ?>
                      「TEL待ち」です
                      <?php elseif( $bookings[0]->booking_status == 3 ): ?>
                      「リコール」です→ <?php echo (empty($bookings[0]->booking_recall_ym)) ? '' : date('Y-m', strtotime($bookings[0]->booking_recall_ym)); ?>
                      <?php elseif( $bookings[0]->booking_status == 4 ): ?>
                      未作成技工物TEL待ち
                      <?php elseif( $bookings[0]->booking_status == 5 ): ?>
                      作成済み技工物キャンセル
                      <?php endif; ?>
                  </td>
                </tr>
            ...
            <?php if(!empty($bookings[1])): ?>
              <tbody>
                ...
                <tr>
                  <td class="col-title">予約ステータス</td>
                  <td>
                      <?php if( $bookings[1]->booking_status == 1 ): ?>
                      通常
                      <?php elseif( $bookings[1]->booking_status == 2 ): ?>
                      「TEL待ち」です
                      <?php elseif( $bookings[1]->booking_status == 3 ): ?>
                      「リコール」です→ <?php echo (empty($bookings[1]->booking_recall_ym)) ? '' : date('Y-m', strtotime($bookings[1]->booking_recall_ym)); ?>
                      <?php elseif( $bookings[1]->booking_status == 4 ): ?>
                      未作成技工物TEL待ち
                      <?php elseif( $bookings[1]->booking_status == 5 ): ?>
                      作成済み技工物キャンセル
                      <?php endif; ?>
                  </td>
                </tr>

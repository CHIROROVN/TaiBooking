...
<?php echo Form::open(array('route' => ['ortho.bookings.booking.change.date', $booking->booking_id], 'method' => 'post', 'enctype'=>'multipart/form-data')); ?>
...
-->
    <div class="row margin-bottom">
      <div class="col-md-12 text-center">
        <input name="ボタン" onclick="location.href='<?php echo e(route('ortho.bookings.booking.change.confirm', [ $booking->booking_id, 'next' => 'booking_result_calendar' ])); ?>'" value="検索開始（カレンダー表示）" type="button" class="btn btn-sm btn-page mar-right">
        <input name="ボタン2" onclick="location.href='<?php echo e(route('ortho.bookings.booking.change.confirm', [ $booking->booking_id, 'next' => 'booking_result_list' ])); ?>'" value="検索開始（一覧表表示）" type="button" class="btn btn-sm btn-page mar-right">

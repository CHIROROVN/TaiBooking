...
<?php echo Form::open(array('route' => 'ortho.bookings.booking.regist', 'method' => 'post', 'enctype'=>'multipart/form-data')); ?>
    ...
    <div class="row content-page">
      ...
      <table class="table table-bordered">
        <tr>
          ...
          <td><input type="text" name="txtName" id="textName" class="form-control" value="123456 杉元　俊彦"/><input type="button" name="button3" id="button" value="新患です" class="btn btn-sm btn-page" onclick="location.href='<?php echo e(route('ortho.bookings.booking.1st.regist')); ?>'"></td>
        </tr>
        <tr>

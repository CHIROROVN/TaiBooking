            ...
            <?php else: ?>
              ...
              <?php $i++; ?>
                <tr>
                  ...
                  <td align="center"><a href="<?php echo e(route('ortho.clinics.booking.templates.edit', [$clinic_id, $mbt->mbt_id])); ?>" class="btn btn-sm btn-edit">編集</a></td>
                  <td align="center">
                      <button onclick="location.href='<?php echo e(url('ortho/clinics/'.$clinic_id.'/booking/templates/orderby-top?id='.$mbt->mbt_id)); ?>'" class="<?php if($i < 2): ?> <?php echo e('hidden'); ?> <?php endif; ?>">TOP
                    </td>
                    <td align="center" class="">
                      <button onclick="location.href='<?php echo e(url('ortho/clinics/'.$clinic_id.'/booking/templates/orderby-up?id='.$mbt->mbt_id)); ?>'" class="<?php if($i < 2): ?> <?php echo e('hidden'); ?> <?php endif; ?>">↑</button>
                    </td>
                    <td align="center">
                      <button onclick="location.href='<?php echo e(url('ortho/clinics/'.$clinic_id.'/booking/templates/orderby-down?id='.$mbt->mbt_id)); ?>'" class="<?php if($i == $max): ?> <?php echo e('hidden'); ?> <?php endif; ?>">↓</button>
                    </td>
                    <td align="center" class="">
                      <button onclick="location.href='<?php echo e(url('ortho/clinics/'.$clinic_id.'/booking/templates/orderby-last?id='.$mbt->mbt_id)); ?>'" class="<?php if($i == $max): ?> <?php echo e('hidden'); ?> <?php endif; ?>">LAST</button>
                    </td>
                </tr>
              <?php endforeach; ?>
            <?php endif; ?>

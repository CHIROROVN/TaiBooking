...
<div class="row content-page">
  <h3>医院情報管理　＞　<?php echo e($clinic->clinic_name); ?>　＞　業務自動枠の一覧　＞　<?php echo e($service->service_name); ?>　＞　使用設備と時間の編集</h3>
    <div class="table-responsive">
    <?php echo Form::open( ['id' => 'frmClinicServiceEdit', 'class' => 'form-horizontal','method' => 'post', 'route' => ['ortho.clinics.services.template_edit', $clinic->clinic_id, $service->service_id, $clinic_service->clinic_service_id], 'enctype'=>'multipart/form-data', 'accept-charset'=>'utf-8']); ?>
        ...
        <table class="table table-bordered">
            <tr>
              ...
              <?php 
                ...
                <input id="service_facility_1_chair_null" type="radio" value="" name="service_facility_1_chair" <?php echo e($sf1_chair_null); ?>>使用しない &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
              ...
              <td>
                <select name="service_time_1" id="service_time_1" class="form-control form-control--small">
                  <option value="" <?php if($clinic_service->service_time_1 == ''): ?> selected="selected" <?php endif; ?>>----</option>
                ...
                <?php if($errors->first('service_time_1')): ?>
                    <span class="error-input">※ <?php echo $errors->first('service_time_1'); ?></span>
                <?php endif; ?>
              </td>
            </tr>
        </table>
        ...
        <table class="table table-bordered">
            <tr>
              ...
              <?php 
                ...
                <input id="service_facility_2_chair_null" type="radio" value="" name="service_facility_2_chair" <?php echo e($sf2_chair_null); ?>>使用しない &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
              ...
              <td>
                <select name="service_time_2" id="service_time_2" class="form-control form-control--small">
                  <option value="" <?php if($clinic_service->service_time_2 == ''): ?> selected="selected" <?php endif; ?>>----</option>
                 ...
                 <?php if($errors->first('service_time_2')): ?>
                    <span class="error-input">※ <?php echo $errors->first('service_time_2'); ?></span>
                <?php endif; ?>
              </td>
            </tr
        </table>
        ...
        <table class="table table-bordered">
            <tr>
              ...
              <?php 
                ...
                <input id="service_facility_3_chair_null" type="radio" value="" name="service_facility_3_chair" <?php echo e($sf3_chair_null); ?>>使用しない &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
              ...
              <td>
                <select name="service_time_3" id="service_time_3" class="form-control form-control--small">
                  <option value="" <?php if($clinic_service->service_time_3 == ''): ?> selected="selected" <?php endif; ?>>----</option>
                 ...
                 <?php if($errors->first('service_time_3')): ?>
                    <span class="error-input">※ <?php echo $errors->first('service_time_3'); ?></span>
                <?php endif; ?>
              </td>
            </tr
        </table>
        ...
        <table class="table table-bordered">
            <tr>
              ...
              <?php 
                ...
                <input id="service_facility_4_chair_null" type="radio" value="" name="service_facility_4_chair" <?php echo e($sf4_chair_null); ?>>使用しない &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
              ...
              <td>
                <select name="service_time_4" id="service_time_4" class="form-control form-control--small">
                  <option value="" <?php if($clinic_service->service_time_4 == ''): ?> selected="selected" <?php endif; ?>>----</option>
                 ...
                 <?php if($errors->first('service_time_4')): ?>
                    <span class="error-input">※ <?php echo $errors->first('service_time_4'); ?></span>
                <?php endif; ?>
              </td>
            </tr
        </table>
        ...
        <table class="table table-bordered">
            <tr>
              ...
              <?php 
                ...
                <input id="service_facility_5_chair_null" type="radio" value="" name="service_facility_5_chair" <?php echo e($sf5_chair_null); ?>>使用しない &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <select name="service_time_5" id="service_time_5" class="form-control form-control--small">
              <option value="" <?php if($clinic_service->service_time_5 == ''): ?> selected="selected" <?php endif; ?>>----</option>
             ...
             <?php if($errors->first('service_time_5')): ?>
                    <span class="error-input">※ <?php echo $errors->first('service_time_5'); ?></span>
                <?php endif; ?>
          </td>
        </tr>
      </table>
...
<div class="row margin-bottom">
  <div class="col-md-12 text-center">
    ...
    <!-- delete -->
    <?php if( $clinic_service->clinic_service_id ): ?>
      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <a href="<?php echo e(route('ortho.clinics.services.template_delete', [ $clinic->clinic_id, $service->service_id, $clinic_service->clinic_service_id ])); ?>" class="btn btn-sm btn-page"><?php echo e(trans('common.modal_btn_delete')); ?></a>
...
<div class="row margin-bottom">
  <div class="col-md-12 text-center">
    <input type="button" onClick="location.href='<?php echo e(route('ortho.facilities.index', [ $clinic->clinic_id ])); ?>'" value="登録済み自動枠の構成一覧に戻る" class="btn btn-sm btn-page">
  </div>
</div>
<?php echo Form::close(); ?>

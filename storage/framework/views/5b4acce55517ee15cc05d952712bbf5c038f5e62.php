      ...
      <div class="container-fulid">
        <div class="row">
          <div class="col-md-6">
            ...
            <span>ようこそ、<?php if(Auth::check()): ?> <?php echo e(Auth::user()->u_name_display); ?> <?php endif; ?> (<a href="<?php echo e(route('ortho.change.password', [Auth::user()->id])); ?>" class="text-orange">パスワード変更</a>）</span>
          </div>

...
<link href="<?php echo e(asset('')); ?>public/backend/ortho/common/css/style.css" rel="stylesheet">
...
<script src="<?php echo e(asset('')); ?>public/backend/ortho/common/js/jquery-1.9.1.min.js"></script>
<!-- <script src="<?php echo e(asset('')); ?>public/backend/ortho/common/js/jquery-migrate-1.2.0.min.js"></script> -->
...
<script src="<?php echo e(asset('')); ?>public/backend/ortho/common/js/jquery.fixedtable.js"></script>
</head>
<body>
  <!-- Header -->
    <header>

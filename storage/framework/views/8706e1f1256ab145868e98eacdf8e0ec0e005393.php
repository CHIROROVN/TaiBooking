        ...
        <div class="fillter">
          ...
          <?php echo Form::open(array('route' => 'ortho.bookings.booking.monthly', 'id'=>'bookingMonthly', 'method' => 'get', 'enctype'=>'multipart/form-data')); ?>
            ...
            <select name="u_id" id="u_id" class="form-control form-control--small">
              ...
              <option value="<?php echo e($doctor->id); ?>" <?php if($u_id == $doctor->id): ?> selected="" <?php endif; ?>><?php echo e($doctor->u_name); ?></option>
              <?php endforeach; ?>
            </select>
  ...
  $(document).ready(function() {
    ...
    var calendar = $('#calendar').fullCalendar({
      ...
      select: function(start, end, allDay) {
        ...
        window.location.href = "<?php echo e(route('ortho.bookings.booking.daily')); ?>?start_date=" + start + "&clinic_id=<?php echo e(@$clinic_id); ?>";
        // location.reload();
      },
    });
  });

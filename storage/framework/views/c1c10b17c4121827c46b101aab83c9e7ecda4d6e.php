      ...
      <div class="container">
        <div class="row content content--list">
          ...
          <div class="text-right">
            <input onclick="location.href='<?php echo e(route('backend.students.contact.regist')); ?>'" value="お問い合わせ情報の新規登録" type="button" class="btn btn-sm btn-primary">
          </div>
          <table class="table table-bordered table-striped clearfix">
            ...
            <?php if(count($contacts) > 0): ?>
              <?php foreach($contacts as $contact): ?>
                <tr>
                  <td><?php echo e(@formatDate($contact->contact_date)); ?></td>
                  <td><?php echo e($contact->contact_title); ?></td>
                  <td><?php echo e(@$users[$contact->contact_fst_user]); ?></td>
                  <td align="center"><input onclick="location.href='<?php echo e(route('backend.students.contact.detail')); ?>'" value="詳細" type="button" class="btn btn-xs btn-primary"></td>
                  <td align="center"><input onclick="location.href='<?php echo e(route('backend.students.contact.edit')); ?>'" value="編集" type="button" class="btn btn-xs btn-primary"></td>
                  <td align="center"><input onclick="location.href='<?php echo e(route('backend.students.contact.delete_cnf')); ?>'" value="削除" type="button" class="btn btn-xs btn-primary"></td>
                </tr>
              <?php endforeach; ?>
            <?php else: ?>

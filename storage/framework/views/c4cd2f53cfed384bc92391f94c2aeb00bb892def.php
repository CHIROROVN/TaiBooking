      ...
      <h3>患者管理　＞　登録済み患者情報の編集</h3>
        <div class="table-responsive">
          <table class="table table-bordered">
            <input type="hidden" name="cur_p_no" value="<?php echo e($patient->p_no); ?>" />
            <!-- p_no -->
            <tr>
              <td class="col-title"><label for="p_no">カルテNo</label></td>
              <td>
                <?php if( old('p_no') ): ?>
                <input type="text" name="p_no" id="p_no" class="form-control" maxlength="8" value="<?php echo e(old('p_no')); ?>" />
                <?php else: ?>
                <input type="text" name="p_no" id="p_no" class="form-control" maxlength="8" value="<?php echo e($patient->p_no); ?>" />
                <?php endif; ?>

          ...
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <?php
                ...
                // }
              ?>
              <td align="center" width=""><span data-u-id="" data-facility-id="<?php echo e($facility->facility_id); ?>" class="popup popup-dotor" data-toggle="popover" title="<?php echo e(trans('common.popup_header')); ?>" data-content='
                <ul>
                  <?php echo e($str); ?>
            ...
            <tr>
              ...
              <?php
                ...
                $str .= '<li><label class="radio"><input type="radio" class="input-user" text="" name="doctor-facility-' . $facility->facility_id . '" value="-1" >' . trans('common.select_reset') . '</label></li>';
              ?>
              <td align="center" width=""><span data-u-id="" data-facility-id="<?php echo e($facility->facility_id); ?>" class="popup popup-hygienist" data-toggle="popover" title="<?php echo e(trans('common.popup_header')); ?>" data-content='
                <ul>
                  <?php echo e($str); ?>
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-shift-set">
            <tr>
              ...
              <?php foreach( $facilitys as $facility ): ?>
              <td align="center" style=""><?php echo e($facility->facility_name); ?></td>
              <?php endforeach; ?>
            </tr>
